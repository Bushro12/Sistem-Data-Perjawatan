    ...
    <div class="esdap-login-wrapper">
        <div class="esdap-login-card">
            <div class="esdap-login-left">
                ...
                <h1 class="esdap-login-title">Lupa Kata Laluan<span class="esdap-dot">.</span></h1>
                <p class="esdap-login-sub">Masukkan No. Kad Pengenalan anda. Jika rekod wujud, pautan reset akan dihantar ke emel berdaftar.</p>

                <div class="esdap-form-area">
                    {{ $this->content }}
                </div>

                <p class="esdap-auth-alt">
                    <a href="{{ filament()->getLoginUrl() }}">Kembali ke Log Masuk</a>
                </p>
            </div>
